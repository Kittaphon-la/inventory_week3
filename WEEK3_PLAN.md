...
| บทบาท | สมาชิก |
|---|---|
| Project Manager | นายจิรกิตติ คำป่าตัน |
...
| กิจกรรม | นายจิรกิตติ คำป่าตัน | นางสาว กฤตพร แหลมไทย | นายณัฐกิตติ์ แก้วคำยศ | นายวรวิทย์ สุวรรณ |
|---|---:|---:|---:|---:|
...
| Test ID | รายการทดสอบ | ผลที่คาดหวัง | ผลจริง | สถานะ |
|---|---|---|---|---|
| UAT-01 | เลือกเมนู Show all | แสดงสินค้าทั้งหมด | แสดงถูกต้อง | Pass |
| UAT-02 | เพิ่มสินค้าใหม่ | บันทึกสินค้าได้ | ทำงานถูกต้อง | Pass |
| UAT-03 | กรอกตัวอักษรใน Qty | โปรแกรมไม่ล่มและให้กรอกใหม่ | ทำงานถูกต้อง | Pass |
| UAT-04 | ตัดสต็อกปกติ | จำนวนสินค้าลดลง | ทำงานถูกต้อง | Pass |
| UAT-05 | ตัดเกินจำนวนที่มี | แจ้ง Not enough stock | ทำงานถูกต้อง | Pass |
| UAT-06 | ตรวจมูลค่ารวม | คำนวณจำนวนและมูลค่าถูกต้อง | ทำงานถูกต้อง | Pass |
